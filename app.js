...
async function siapkanKatalog() {
    ...
    const status = document.querySelector("#status_katalog");
    ...
    try{
       ...
       status.textConten = "Data gagal dimuat. Jalankan proyek melalui server lokal.";
